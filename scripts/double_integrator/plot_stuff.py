...
def main(args):
	...
	# plot_nominal_trajectory(robust_rc_state_trajectory, robust_rc_nominal_trajectory, "Robust Robust State Trajectory")
	...
	# plot_fe_bounded(robust_ccm_rfe, robust_ccm_rfe_bound, "Robust CCM Real Free Energy")
	...
	# plot_nominal_trajectory(robust_ccm_state_trajectory, robust_ccm_nominal_trajectory, "Robust CCM State Trajectory")
