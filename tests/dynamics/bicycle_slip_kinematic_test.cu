...
//   // EXPECT_NEAR(output(23), -5.5, tol);
//
//   // // Apply full brake and half left turn to a moving state oriented 30 degrees to the left which is already
//   turning
...
//
//   // /**
//   //  * Apply full brake and half left turn to a backwards moving state oriented 30 degrees to the left which is
//   already
...
//   //  * angle and steering rate. We are also on a downward facing hill and are already oriented 30 degrees to the
//   left
//   //  */
//   // steer_angle *= 100;
//   // state << -1.0, yaw, 0, 0, steer_angle, 1.0, 0, pitch, 0, 0;
