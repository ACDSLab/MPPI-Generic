...
TEST(ARNeuralNetDynamics, full) {
  ...
  for(int y_dim = 1; y_dim < 17; y_dim++) {
    ...
    launchFullARNNTestKernel<NeuralNetModel<7, 2, 3, 6, 32, 32, 4>, 7, 2, 1, 1>(model, s, u,
                                                                          s_der, 0.1, y_dim);
    ...
    launchFullARNNTestKernel<NeuralNetModel<7, 2, 3, 6, 32, 32, 4>, 7, 2, 1>(model, s, u,
                                                                             s_der, 0.1, y_dim);
...
TEST(ARNeuralNetDynamics, fullComparedToAutoRallyImpl) {
  ...
  for(int y_dim = 1; y_dim < 33; y_dim++) {
    ...
    launchFullARNNTestKernel<NeuralNetModel<7, 2, 3, 6, 32, 32, 4>, 7, 2, 7>(model, s_temp, u_temp,
                                                                          s_der_temp, 1.0/50, y_dim);
