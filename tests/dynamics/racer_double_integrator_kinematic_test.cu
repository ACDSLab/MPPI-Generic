...
//   RacerDoubleIntegratorKinematic::state_array state_der = RacerDoubleIntegratorKinematic::state_array::Ones() *
//   0.153; dynamics.computeDynamics(x, u, state_der); EXPECT_FLOAT_EQ(state_der(0), 0);   // x
...
//   std::vector<float> engine_theta(RacerDoubleIntegratorKinematic::ENGINE_LSTM::OUTPUT_PARAMS_T::NUM_PARAMS);
...
//   RacerDoubleIntegratorKinematic dynamics = RacerDoubleIntegratorKinematic(mppi::tests::ackerman_test);
//
//   auto params = dynamics.getParams();
//   params.max_steer_angle = 5.0;
//   params.wheel_base = 2.981;
...
//     for (int i = 0; i < 5; i++)
//     {
//       EXPECT_NEAR(dynamics.getDelayHelper()->getLSTMModel()->getHiddenState()(i), delay_init_hidden[5 * point + i],
//       tol)
...
//     for (int i = 0; i < 5; i++)
//     {
//       EXPECT_NEAR(dynamics.getSteerHelper()->getLSTMModel()->getHiddenState()(i), steer_init_hidden[5 * point + i],
//       tol)
//           << "at point " << point << " index " << i;
...
//                   tol)
//           << "at point " << point << " index " << i;
//       EXPECT_NEAR(dynamics.getEngineHelper()->getLSTMModel()->getCellState()(i), engine_init_cell[5 * point + i],
//       tol)
//           << "at point " << point << " index " << i;
//     }
//     for (int i = 0; i < 10; i++)
//     {
//       EXPECT_NEAR(dynamics.getTerraHelper()->getLSTMModel()->getHiddenState()(i), terra_init_hidden[10 * point + i],
//       tol)
//           << "at point " << point << " index " << i;
