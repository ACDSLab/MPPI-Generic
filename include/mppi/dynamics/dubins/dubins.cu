...
DubinsDynamics::DubinsDynamics(cudaStream_t stream) :
        Dynamics<DubinsDynamics, DubinsParams, 3, 2>(stream) {
...
__device__ void DubinsDynamics::computeDynamics(float* state, float* control,
