...
BicycleSlipHybrid::BicycleSlipHybrid(cudaStream_t stream)
  : BicycleSlipKinematicImpl<BicycleSlipHybrid, BicycleSlipHybridParams>(stream)
{
}
  ...
  : BicycleSlipHybrid::BicycleSlipHybrid(stream)
{
  ...
  this->params_.c_t[0] = param_dict.at("terra_model/params/ax_t_low").data<float>()[0];
  this->params_.c_t[1] = param_dict.at("terra_model/params/ax_t").data<float>()[0];
  this->params_.c_b[0] = param_dict.at("terra_model/params/ax_b_low").data<float>()[0];
  this->params_.c_b[1] = param_dict.at("terra_model/params/ax_b").data<float>()[0];
  this->params_.c_v[0] = param_dict.at("terra_model/params/ax_v_low").data<float>()[0];
  this->params_.c_v[1] = param_dict.at("terra_model/params/ax_v").data<float>()[0];

  // ay linear model
  this->params_.ay_angle = param_dict.at("terra_model/params/ay_angle").data<float>()[0];
  this->params_.ay_t[0] = param_dict.at("terra_model/params/ay_t_low").data<float>()[0];
  this->params_.ay_t[1] = param_dict.at("terra_model/params/ay_t").data<float>()[0];
  this->params_.ay_b[0] = param_dict.at("terra_model/params/ay_b_low").data<float>()[0];
  this->params_.ay_b[1] = param_dict.at("terra_model/params/ay_b").data<float>()[0];
  this->params_.ay_v[0] = param_dict.at("terra_model/params/ay_v_low").data<float>()[0];
  this->params_.ay_v[1] = param_dict.at("terra_model/params/ay_v").data<float>()[0];

  // omega model
  this->params_.omega_v[0] = param_dict.at("terra_model/params/omega_v_low").data<float>()[0];
  this->params_.omega_v[1] = param_dict.at("terra_model/params/omega_v").data<float>()[0];
  this->params_.steer_angle_scale = param_dict.at("terra_model/params/steer_angle_scale").data<float>()[0];
