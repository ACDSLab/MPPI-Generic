...
__global__ void rearrangeNoise(float* input, float* output, int num_trajectories, int num_timesteps, int control_dim)
{
                           ...
                           float* control_noise_d, curandGenerator_t& gen, cudaStream_t stream = 0, int fmin = 0)
{
  ...
  rearrangeNoise<<<reorder_grid, reorder_block, 0, stream>>>(noise_in_time_d, control_noise_d, num_trajectories,
