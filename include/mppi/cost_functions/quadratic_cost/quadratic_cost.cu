...
template <class CLASS_T, class DYN_T, class PARAMS_T>
float QuadraticCostImpl<CLASS_T, DYN_T, PARAMS_T>::computeStateCost(const Eigen::Ref<const state_array> s, int timestep,
                                                                    int* crash_status)
{
  float cost = 0;
...
template <class CLASS_T, class DYN_T, class PARAMS_T>
float QuadraticCostImpl<CLASS_T, DYN_T, PARAMS_T>::terminalCost(const Eigen::Ref<const state_array> s)
{
  return 0.0;
}
